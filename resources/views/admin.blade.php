<!DOCTYPE html>
    ...
    <div class="wrapper">
          ...
          <span class="input-group-btn">
            <button type='submit' name='search' id='search-btn' class="btn btn-flat"><i class="fa fa-search"></i></button>
                ...
                <ul class="sidebar-menu">
                    ...
                    <li><a href="#"><span>Share Info</span></a></li>
                         <li class="treeview">
          <a href="#">
            <i class="fa fa-share"></i> <span>Properties</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> View Property</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Register Property</a></li>
          </ul>
        </li>
                </ul><!-- /.sidebar-menu -->
            </section>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>&copy; <?php echo date("Y");  ?> <a href="#">Company</a>.</strong> All rights reserved.
        </footer>
